...
byte known_keys[NR_KNOWN_KEYS][MFRC522::MF_KEY_SIZE] =  {
...
void setup() {
  // Set watchdog timeout long enough
  ESP.wdtDisable();
...
/* Try default keys and save sector to JSON passed as ref */
